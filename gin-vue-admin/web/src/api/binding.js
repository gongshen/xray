...
export const createBinding = (data) => {
  return service({
    url: '/v2ray_admin/binding/createBinding',
    method: 'post',
    data
  })
}
...
export const deleteBinding = (data) => {
  return service({
    url: '/v2ray_admin/binding/deleteBinding',
    method: 'delete',
    data
  })
}
...
export const deleteBindingByIds = (data) => {
  return service({
    url: '/v2ray_admin/binding/deleteBindingByIds',
    method: 'delete',
    data
  })
}
...
export const updateBinding = (data) => {
  return service({
    url: '/v2ray_admin/binding/updateBinding',
    method: 'put',
    data
  })
}
...
export const findBinding = (params) => {
  return service({
    url: '/v2ray_admin/binding/findBinding',
    method: 'get',
    params
  })
}
...
export const getBindingList = (params) => {
  return service({
    url: '/v2ray_admin/binding/getBindingList',
    method: 'get',
    params
  })
}
...
export const shareBinding = (params) => {
  return service({
    url: '/v2ray_admin/binding/shareBinding',
    method: 'get',
    params
  })
}