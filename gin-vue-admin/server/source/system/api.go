...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "系统用户", Method: "POST", Path: "/user/getAllUser", Description: "获取所有用户信息"},
		...
		{ApiGroup: "v2ray_admin", Method: "POST", Path: "/v2ray_admin/stat/createStat", Description: "新建流量统计"},
		{ApiGroup: "v2ray_admin", Method: "GET", Path: "/v2ray_admin/stat/getStatList", Description: "获取流量统计列表"},
		{ApiGroup: "v2ray_admin", Method: "PUT", Path: "/v2ray_admin/stat/updateStat", Description: "更新流量统计"},
		...
		{ApiGroup: "v2ray_admin", Method: "PUT", Path: "/v2ray_admin/server/updateServer", Description: "更新服务器ip"},
		{ApiGroup: "v2ray_admin", Method: "DELETE", Path: "/v2ray_admin/server/deleteServer", Description: "删除服务器ip"},
		{ApiGroup: "v2ray_admin", Method: "DELETE", Path: "/v2ray_admin/server/deleteServerByIds", Description: "批量删除服务器ip"},
		...
		{ApiGroup: "v2ray_admin", Method: "POST", Path: "/v2ray_admin/server/classifyTrafficTargets", Description: "访问目标分类"},
		...
		{ApiGroup: "v2ray_admin", Method: "DELETE", Path: "/v2ray_admin/binding/deleteBindingByIds", Description: "批量删除绑定"},
		{ApiGroup: "v2ray_admin", Method: "PUT", Path: "/v2ray_admin/binding/updateBinding", Description: "更新绑定"},
		{ApiGroup: "v2ray_admin", Method: "GET", Path: "/v2ray_admin/binding/findBinding", Description: "根据ID获取绑定"},
		{ApiGroup: "v2ray_admin", Method: "GET", Path: "/v2ray_admin/binding/getBindingList", Description: "获取绑定列表"},
		{ApiGroup: "v2ray_admin", Method: "GET", Path: "/v2ray_admin/binding/shareBinding", Description: "绑定分享"},

		{ApiGroup: "v2ray", Method: "GET", Path: "/v2ray/stat/getStatList", Description: "获取流量统计列表"},
		{ApiGroup: "v2ray", Method: "GET", Path: "/v2ray/stat/getStatCharts", Description: "获取流量统计图"},

		{ApiGroup: "v2ray", Method: "GET", Path: "/v2ray/binding/getBindingList", Description: "获取绑定列表"},
		{ApiGroup: "v2ray", Method: "GET", Path: "/v2ray/binding/shareBinding", Description: "绑定分享"},
	}
