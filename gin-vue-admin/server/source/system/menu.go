...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "0", Path: "person", Name: "person", Component: "view/person/person.vue", Sort: 4, Meta: Meta{Title: "个人信息", Icon: "message"}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "0", Path: "v2ray_admin", Name: "v2ray_admin", Component: "view/routerHolder.vue", Sort: 100, Meta: Meta{Title: "代理管理", Icon: "unlock"}},
		{MenuLevel: 0, Hidden: false, ParentId: "0", Path: "v2ray", Name: "v2ray", Component: "view/routerHolder.vue", Sort: 100, Meta: Meta{Title: "代理", Icon: "unlock"}},
		{MenuLevel: 0, Hidden: false, ParentId: "30", Path: "v2ray_admin/stat", Name: "v2ray_admin/stat", Component: "view/v2ray_admin/stat/stat.vue", Sort: 1, Meta: Meta{Title: "流量统计", Icon: "data-analysis"}},
		{MenuLevel: 0, Hidden: false, ParentId: "30", Path: "v2ray_admin/server", Name: "v2ray_admin/server", Component: "view/v2ray_admin/server/server.vue", Sort: 2, Meta: Meta{Title: "服务器", Icon: "platform"}},
		{MenuLevel: 0, Hidden: false, ParentId: "30", Path: "v2ray_admin/binding", Name: "v2ray_admin/binding", Component: "view/v2ray_admin/binding/binding.vue", Sort: 3, Meta: Meta{Title: "绑定", Icon: "link"}},
		{MenuLevel: 0, Hidden: false, ParentId: "31", Path: "v2ray/stat", Name: "v2ray/stat", Component: "view/v2ray/stat/stat.vue", Sort: 1, Meta: Meta{Title: "流量统计", Icon: "link"}},
		{MenuLevel: 0, Hidden: false, ParentId: "31", Path: "v2ray/binding", Name: "v2ray/binding", Component: "view/v2ray/binding/binding.vue", Sort: 2, Meta: Meta{Title: "绑定", Icon: "link"}},
	}
