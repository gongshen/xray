...
func (s *BindingRouter) InitBindingRouter(Router *gin.RouterGroup) {
	bindingRouter := Router.Group("v2ray_admin/binding").Use(middleware.OperationRecord())
	bindingRouterWithoutRecord := Router.Group("v2ray_admin/binding")
	var bindingApi = v1.ApiGroupApp.V2rayAdminApiGroup.BindingApi
	{
