...
func (userService *UserService) DeleteUser(id int) (err error) {
	err = global.GVA_DB.Delete(&system.SysUser{}, "id = ?", id).Error
	if err != nil {
		return err
	}
...
func (userService *UserService) SetUserInfo(req system.SysUser) error {
	return global.GVA_DB.Model(&system.SysUser{}).
		Select("updated_at", "nick_name", "header_img", "phone", "email", "sideMode", "enable", "traffic_limit").
		Where("id=?", req.ID).
...
func (userService *UserService) GetAllUser() (users []*system.SysUser, err error) {
