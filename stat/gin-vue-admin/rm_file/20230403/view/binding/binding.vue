<template>
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束时间"></el-date-picker>
        ...
        <el-form-item label="服务器ip">
         <el-input v-model="searchInfo.server_ip" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="服务器ip" prop="server_ip" width="120" />
        <el-table-column align="left" label="用户名" prop="username" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="updateBindingFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        <el-form-item label="服务器ip:"  prop="server_ip" >
          <el-input v-model="formData.server_ip" :clearable="true"  placeholder="请输入" />
        </el-form-item>
...
// 更新行
const updateBindingFunc = async(row) => {
    const res = await findBinding({ ID: row.ID })
    type.value = 'update'
    if (res.code === 0) {
        formData.value = res.data.rebinding
