<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="重置日" width="180">
            <template #default="scope">{{ formatDate(scope.row.reset_date) }}</template>
        </el-table-column>
...
<!--            <el-button type="primary" link icon="edit" class="table-button" @click="updateServerFunc(scope.row)">变更</el-button>-->
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="重置时间:"  prop="resetDate">
          <el-date-picker v-model="formData.reset_date" type="datetime" :clearable="false" placeholder="重置时间"></el-date-picker>
        </el-form-item>
      </el-form>
      <template #footer>
...
import PreviewCodeDialg from "../systemTools/autoCode/component/previewCodeDialg.vue";
import AutoCode from "../systemTools/autoCode/index.vue";
...
const rule  = reactive({
  ...
  reset_date: [
    { required: true, message: '请输入重置时间', trigger: 'blur' },
  ],
})
