...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "30", Path: "stat", Name: "stat", Component: "view/stat/stat.vue", Sort: 1, Meta: Meta{Title: "流量统计", Icon: "data-analysis"}},
		{MenuLevel: 0, Hidden: false, ParentId: "30", Path: "server", Name: "server", Component: "view/server/server.vue", Sort: 2, Meta: Meta{Title: "服务器", Icon: "platform"}},
		{MenuLevel: 0, Hidden: false, ParentId: "30", Path: "binding", Name: "binding", Component: "view/binding/binding.vue", Sort: 3, Meta: Meta{Title: "绑定", Icon: "link"}},
	}
