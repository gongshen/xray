...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "v2ray", Method: "POST", Path: "/stat/createStat", Description: "新建流量统计"},
		{ApiGroup: "v2ray", Method: "GET", Path: "/stat/getStatList", Description: "获取流量统计列表"},
		{ApiGroup: "v2ray", Method: "PUT", Path: "/stat/updateStat", Description: "更新流量统计"},
		{ApiGroup: "v2ray", Method: "DELETE", Path: "/stat/deleteStat", Description: "删除流量统计"},
		{ApiGroup: "v2ray", Method: "DELETE", Path: "/stat/deleteStatByIds", Description: "批量删除流量统计"},

		{ApiGroup: "v2ray", Method: "POST", Path: "/server/createServer", Description: "新增服务器ip"},
		{ApiGroup: "v2ray", Method: "GET", Path: "/server/getServerList", Description: "获取服务器ip列表"},
		{ApiGroup: "v2ray", Method: "PUT", Path: "/server/updateServer", Description: "更新服务器ip"},
		{ApiGroup: "v2ray", Method: "DELETE", Path: "/server/deleteServer", Description: "删除服务器ip"},
		{ApiGroup: "v2ray", Method: "DELETE", Path: "/server/deleteServerByIds", Description: "批量删除服务器ip"},
		{ApiGroup: "v2ray", Method: "GET", Path: "/server/findServer", Description: "根据ID获取服务器ip"},
		{ApiGroup: "v2ray", Method: "POST", Path: "/server/getAllServer", Description: "获取所有Server"},

		{ApiGroup: "v2ray", Method: "POST", Path: "/binding/createBinding", Description: "新增绑定"},
		{ApiGroup: "v2ray", Method: "DELETE", Path: "/binding/deleteBinding", Description: "删除绑定"},
		{ApiGroup: "v2ray", Method: "DELETE", Path: "/binding/deleteBindingByIds", Description: "批量删除绑定"},
		{ApiGroup: "v2ray", Method: "PUT", Path: "/binding/updateBinding", Description: "更新绑定"},
		{ApiGroup: "v2ray", Method: "GET", Path: "/binding/findBinding", Description: "根据ID获取绑定"},
		{ApiGroup: "v2ray", Method: "GET", Path: "/binding/getBindingList", Description: "获取绑定列表"},
		{ApiGroup: "v2ray", Method: "GET", Path: "/binding/shareBinding", Description: "绑定分享"},
	}
